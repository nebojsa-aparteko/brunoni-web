...
import ImcoContainer from '../bookings/ImcoContainer';
...
const BookingRequestContainerDetails: React.FC<Props> = ({ containers, version, category, tariffDetails, remarks }) => {
...
export default BookingRequestContainerDetails;
